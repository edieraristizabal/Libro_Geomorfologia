...
```{figure} images/BlueMarble_TopografiaGlobal.jpg
:name: fig-intro
:width: 800px

Topografía y batimetría global (Blue Marble Next Generation). Imagen: Reto Stöckli, NASA Earth Observatory, [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Blue_Marble_Next_Generation_+_topography_+_bathymetry.jpg) (dominio público).
```

**Como referenciar**: Aristizábal Edier. 2026. Libro guía del curso Geomorfología de la Facultad de Minas, Universidad Nacional de Colombia.
