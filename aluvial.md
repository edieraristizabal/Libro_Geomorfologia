...
* **Estructuras de Sedimentación:**
    ...
    * **Secuencias de *Fining Upward* (Granoclasificación Inversa):** La regla común en depósitos aluviales. El tamaño de grano disminuye gradualmente hacia arriba, reflejando la pérdida de energía del flujo con el tiempo (ej. arena gruesa en el canal a limos en la llanura de inundación).
...
* **Nivel de Banco Lleno (*Bankfull*):** Es el nivel de caudal en el que el agua justo antes de desbordarse e inundar la llanura. Es el caudal que se considera "de diseño" para el canal y es el que realiza la mayor parte del trabajo de modelado del canal.
